<template>
  <div class="filter-travel cl-1">
    <div class="filter-item">
      <span class="filter__label">Khoảng giá (khách/tour)</span>
...
const emit = defineEmits(['filterTour'])
...
const debounceFilterTour = debounce(filterTour, 300)
